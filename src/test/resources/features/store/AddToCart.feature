...
Feature: Add items to cart
  ...
  Scenario: Add items from the inventory page
    ...
    And I take an add screenshot with filename "itemsAddedFromInventory1"
    ...
    And I take an add screenshot with filename "itemsAddedFromInventory2"
    When I click the cart button to see the items I added
    Then I check the cart page displays the items I added:
      | Sauce Labs Onesie                 |
      | Test.allTheThings() T-Shirt (Red) |
    And I take an add screenshot with filename "itemsAddedFromInventoryCart"
    And I quit the store webpage

  Scenario: Add items from the item page
    Given I go to the store webpage
    Then I login to the store webpage
    And I take an add screenshot with filename "itemsAddedFromItemPageStart"
    ...
    Then I check the shopping cart icon displays a badge with value "1"
    And I take an add screenshot with filename "itemAddedFromItemPage1"
    ...
    Then I check the button in the item page has changed to remove
    Then I check the shopping cart icon displays a badge with value "2"
    And I take an add screenshot with filename "itemAddedFromItemPage2"
    When I click the cart button to see the items I added
    Then I check the cart page displays the items I added:
      | Sauce Labs Bolt T-Shirt |
      | Sauce Labs Backpack     |
    And I take an add screenshot with filename "itemsAddedFromItemPageCart"
    And I quit the store webpage

  Scenario: Add items from the inventory and from the item page
    Given I go to the store webpage
    Then I login to the store webpage
    And I take an add screenshot with filename "itemsAddedMixStart"
    ...
    Then I check the button in the item page has changed to remove
    Then I check the shopping cart icon displays a badge with value "1"
    And I take an add screenshot with filename "itemAdded1"
    And I get back to the inventory page clicking the button "Back to products"
    ...
    Then I check the shopping cart icon displays a badge with value "2"
    And I take an add screenshot with filename "itemAdded2"
    When I click the cart button to see the items I added
    Then I check the cart page displays the items I added:
      | Sauce Labs Bike Light    |
      | Sauce Labs Fleece Jacket |
    And I take an add screenshot with filename "itemsAddedMixCart"
    And I quit the store webpage